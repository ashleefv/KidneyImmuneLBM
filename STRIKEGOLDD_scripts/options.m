...
modelname ='networkODE_k.mat';    % Name of a .mat file placed in the 'models' folder 
...
opts.affine_parallel     = 1;     % use parallel toolbox (=1) or not (=0) to calculate partial ranks.
