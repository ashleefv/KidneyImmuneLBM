...
if state == 'diab_mice'
    ...
    figure(2)
    yyaxis left
    plot([336:length(GLU_p(:,1))]/(24*7), GLU_p(336:3360,1), 'LineWidth', 1, 'Color', [0 0.4470 0.7410], 'LineStyle','--'); 
    ...
    hold on
    legend('Simulated Glucose', 'Finch et al. (2022)', '', 'Lee et al. (2018)', '', 'Normalized Glucose');
    ylim([7.07,52]);
    x0=10;
    y0=10;
    width=800;
    ...
    yyaxis right
    plot(Tout/(24*7), Yout(:,1), 'LineWidth', 2, 'Color', [0.8500 0.3250 0.0980]	, 'LineStyle','-');
