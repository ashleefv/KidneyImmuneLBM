...
function [min_error, error] = networkODE_error(p, params, y0, tspan, tau_index, n_index, k_index, W_index)
...
[t, y] = ode23(@networkODE,tspan,y0,options,params);


Yout = real(y); Tout = t;

% load experimental data from MAT file
% load coupled_exp_data.mat
